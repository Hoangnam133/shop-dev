...
class OrderServiceV5 {
  ...
  //   // Kiểm tra thời gian giao hàng nếu có chọn
  //   if (selectedDeliveryTime) {
  //     console.log("Selected Delivery Time:", selectedDeliveryTime);
  //     const checkTime = await checkDeliveryTimeForShop({
  //       shop_id: shop._id,
  ...
  //     if (checkTime) {
  //       // Nếu thời gian giao hàng hợp lệ
  //       estimated_delivery = selectedDeliveryTime;
  //       options_delivery = "specific_time";
  //     } else {
  //       // Nếu thời gian giao hàng không hợp lệ
  //       throw new BadRequestError("Invalid delivery time");
  //     }
  //   } else {
  //     // Nếu không chọn thời gian giao hàng, kiểm tra giao hàng ngay
  //     const checkTimeImmediate = await checkImmediateDeliveryTime({
  //       shop_id: shop._id,
  //       totalMinutes,
  //     });
  ...
  //   // Lấy thời gian hiện tại cho thời gian đặt hàng (order_time)
  //   const order_time = moment().tz("Asia/Ho_Chi_Minh").format(); // Chuỗi ISO 8601
  ...
  //     order_status: "pending",
  //     order_discount_code: discount_code,
  //     estimated_delivery_time: moment(estimated_delivery)
  //       .tz("Asia/Ho_Chi_Minh")
  //       .format(), // Chuỗi ISO 8601
  //     order_time, // Chuỗi ISO 8601
  //     note,
  //   };
  //   console.log(payload.order_time);
  //   console.log(payload.estimated_delivery_time);
